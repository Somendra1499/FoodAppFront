...
import 'package:firstapp/widgets/expandable_text_widget.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BigText(
                    text: " \u{20B9} ${product.price! * 10} X ${controller.inCartItems}",
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Get.snackbar("Item count", "Items added to your cart!",
                    ...
                    child: Container(
                      ...
                      child: BigText(
                        text:
                            "\u{20B9} ${product.price! * 10 * controller.inCartItems} | Add to cart",
                        color: Colors.white,
                      ),
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(Dimensions.radius20),
