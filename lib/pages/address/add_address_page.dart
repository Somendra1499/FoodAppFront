...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(22.324574208692447, 73.18175349760536), zoom: 17);
  late LatLng _initialPosition = const LatLng(22.324574208692447, 73.18175349760536);
  ...
  void initState() {
    ...
    if (Get.find<LocationController>().addressList.isNotEmpty) {
      ...
      _cameraPosition = CameraPosition(
          target: LatLng(double.parse(Get.find<LocationController>().getAddress["latitude"]),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(width: Dimensions.width10 / 5, color: AppColors.mainColor)),
                  child: Stack(
                    children: [
                      GoogleMap(
                ...
                AppTextField(
                    textController: _addressController, hintText: "Your Address", icon: Icons.map),
                SizedBox(
                  height: Dimensions.height20,
                ),
                Padding(
                  padding: EdgeInsets.only(left: Dimensions.width20),
                  child: BigText(text: "Contact person's name"),
                ),
                SizedBox(
                  height: Dimensions.height20,
                ),
                AppTextField(
                    textController: _contactPersonName, hintText: "Your Name", icon: Icons.person),
                SizedBox(
                  height: Dimensions.height20,
                ),
                Padding(
                  padding: EdgeInsets.only(left: Dimensions.width20),
                  child: BigText(text: "Contact person's phone number"),
                ),
                SizedBox(
                  height: Dimensions.height20,
                ),
