...
class LocationController extends GetxController implements GetxService {
  ...
  int get addressTypeIndex => _adressTypeIndex;
    ...
    if (_updateAddressData) {
      ...
      try {
        ...
        ResponseModel _responseModel = await getZone(
            position.target.latitude.toString(), position.target.longitude.toString(), false);
  ...
  Future<ResponseModel> getZone(String lat, String lng, bool markerLoad) async {
    ...
    print("This is my response body: " + response.body.toString());
    print("zone response code is: " + response.statusCode.toString());
    print("zone response text is: " + response.statusText.toString());
    update();
